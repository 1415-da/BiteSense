  ...
  return (
    ...
    >
      <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
        ...
        <div className="glass" style={{ borderRadius: '1rem', padding: '1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.75rem' }}>
            ...
            <h3 style={{ fontSize: '1.05rem' }}>Library</h3>
          </div>
          ...
          <button type="button" className="btn btn-outline" style={{ marginTop: '0.85rem', width: '100%' }} onClick={() => onNavigate('Recommendations')}>
      ...
      <div style={{ display: 'grid', gap: '0.75rem' }}>
        {meals.map((meal) => (
          <div key={meal.id} className="glass" style={{ borderRadius: '1rem', padding: '1rem', display: 'flex', justifyContent: 'space-between', gap: '1rem', flexWrap: 'wrap' }}>
            <div>
